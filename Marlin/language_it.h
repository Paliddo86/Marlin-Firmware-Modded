...
#define MSG_CHANGE_FIL                      _UxGT("Cambia Filo")
...
#define MSG_GLASS                           _UxGT("Prepara Vetro")
...
#define MSG_INFO_FILAMENT_MENU              _UxGT("Gestione Filo")
#define MSG_FILAMENT_COUNT_RESET            _UxGT("Azzera Filo")
#define MSG_ADD_FILAMENT                    _UxGT("Filo Usato")
#define MSG_SET_FILAMENT                    _UxGT("Imposta Filo")
#define MSG_LOAD_SPOOL                      _UxGT("Imposta Bobina")
#define MSG_INFO_SPOOL_FILAMENT             _UxGT("Bobina da")
...
#else
  #define MSG_FILAMENT_CHANGE_MINTEMP         _UxGT("Temp minima é ")
#endif

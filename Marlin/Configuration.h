...
#define STRING_CONFIG_H_AUTHOR "(Paliddo, Prusa i3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Paliddo i3"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4000, 625.7068 }

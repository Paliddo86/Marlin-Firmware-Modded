...
struct printStatistics {    // 16 bytes (20 with real doubles)
  ...
  double   spoolTotal;      // Total lenght of spool
};
...
/**
 * Add filament used in new spool(Paliddo)
 * 
 */
 void setFilament(double const &setamount);
 /**
  * Add new Spool
  */
  void setSpool(double const &spool);
 /**
  *Reset Filament to 0m for change the spool
  */
  void resetFilament();
    /**
